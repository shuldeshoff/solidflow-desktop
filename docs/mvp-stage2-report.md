...
Задачи:
1. Реализация импорта STL через trimesh ✅ (частично - используется PyVista)
2. Диалог открытия файла ✅ (реализовано)
3. Обработка ошибок импорта ✅ (базовая)
4. Валидация файла (нужно добавить)
5. Отображение загруженной модели ✅ (реализовано)
